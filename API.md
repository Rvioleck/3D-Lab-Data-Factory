...
// 或使用 EventSource
function connectEventSource(sessionId, message) {
    // 创建URL带参数的POST请求需要特殊处理
    // 实际应用中可能需要先发送POST请求获取流ID再连接EventSource
