<template>
  <nav class="new-navbar" :class="{ 'scrolled': isScrolled, 'dark-theme': isDarkTheme }">
    <div class="container">
          ...
          <div v-if="isLoggedIn" class="user-menu">
            ...
            <div class="user-dropdown" v-if="userMenuOpen" @click.stop>
              ...
              <div class="dropdown-body">
                ...
                <router-link v-if="isAdmin" to="/admin/dashboard" class="dropdown-item" @click="closeUserMenu">
