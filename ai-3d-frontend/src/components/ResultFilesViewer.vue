<template>
  <div class="result-files-viewer">
    ...
    <div v-else class="result-files-grid">
      ...
      <!-- 3D模型文件 -->
      <div class="result-file-item" :class="{ 'file-available': outputZipUrl }">
        <div class="file-card">
          ...
          <div class="file-info">
            ...
            <div class="file-actions">
              ...
              <button
                class="btn btn-sm btn-outline-secondary"
                :disabled="!outputZipUrl"
                @click="downloadFile('output_zip')"
              >
                <i class="bi bi-download me-1"></i> 下载
              </button>
            </div>
...
export default {
  ...
  computed: {
    hasAnyFile() {
      return this.pixelImagesUrl || this.xyzImagesUrl || this.outputZipUrl ||
             this.objFileUrl || this.mtlFileUrl || this.textureImageUrl;
    },
    has3DModelFiles() {
